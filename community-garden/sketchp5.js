...
function preload() {
  img1 = loadImage("./assets/bee-01.png");
  img2 = loadImage("./assets/butterfly-01.png");
  img4 = loadImage("./assets/eraser-01.png");
  img5 = loadImage("./assets/fish-01.png");
  img7 = loadImage("./assets/flower1-01.png");
  img8 = loadImage("./assets/flower3-01.png");
  img9 = loadImage("./assets/frog-01.png");
  img10 = loadImage("./assets/lilypad-01.png");
  img11 = loadImage("./assets/mushroom-01.png");
  img12 = loadImage("./assets/pondplant-01.png");
  img13 = loadImage("./assets/sunflower-01.png");
  img14 = loadImage("./assets/worm-01.png");
  img16 = loadImage("./assets/background-01.png");
  img18 = loadImage("./assets/eraser2-01.png");
}

function setup() {
  let c = createCanvas (1300, 813);
  c.parent("p5sketch");
